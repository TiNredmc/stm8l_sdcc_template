...
{
  RI_ICR1   = RI_ICR1_RESET_VALUE;     /*!< Set RI_ICR1 to reset value */
  RI_ICR2   = RI_ICR2_RESET_VALUE;     /*!< Set RI_ICR2 to reset value */
  RI_IOSR1  = RI_IOSR1_RESET_VALUE;    /*!< Set RI_IOSR1 to reset value */
  RI_IOSR2  = RI_IOSR2_RESET_VALUE;    /*!< Set RI_IOSR2 to reset value */
  RI_IOSR3  = RI_IOSR3_RESET_VALUE;    /*!< Set RI_IOSR3 to reset value */
  RI_IOSR4  = RI_IOSR4_RESET_VALUE;    /*!< Set RI_IOSR3 to reset value */
  RI_ASCR1  = RI_ASCR1_RESET_VALUE;    /*!< Set RI_ASCR1 to reset value */
  RI_ASCR2  = RI_ASCR2_RESET_VALUE;    /*!< Set RI_ASCR2 to reset value */
  RI_RCR    = RI_RCR_RESET_VALUE;      /*!< Set RI_RCR to reset value */
}
...
void SYSCFG_RIAnalogSwitchConfig(RI_AnalogSwitch_TypeDef RI_AnalogSwitch, FunctionalState NewState)
{
  ...
  if (NewState != DISABLE)
  {
    if (AnalogSwitchRegister == (uint8_t) 0x10)
    {
      ...
      RI_ASCR1 |= (uint8_t) ((uint8_t)1 << (uint8_t) AnalogSwitchIndex);
    }
    else
    {
      /* Enable the analog switch */
      RI_ASCR2 |= (uint8_t) ((uint8_t)1 << (uint8_t) AnalogSwitchIndex);
    }
  }
  else
  {
    if (AnalogSwitchRegister == (uint8_t) 0x10)
    {
      ...
      RI_ASCR1 &= (uint8_t) (~(uint8_t)((uint8_t)1 <<  AnalogSwitchIndex));
    }
    else
    {
      /* Disable the analog switch */
      RI_ASCR2 &= (uint8_t) (~ (uint8_t)((uint8_t)1 << AnalogSwitchIndex));
    }
  }
}
...
void SYSCFG_RIIOSwitchConfig(RI_IOSwitch_TypeDef RI_IOSwitch, FunctionalState NewState)
{
  ...
  if (IOSwitchRegister == (uint8_t) 0x10)
  {
    if (NewState != DISABLE)
    {
      ...
      RI_IOSR1 |= (uint8_t) ((uint8_t)1 << IOSwitchIndex);
    }
    else
    {
      /* Open the Input Output switch */
      RI_IOSR1 &= (uint8_t) (~ (uint8_t)((uint8_t)1 << IOSwitchIndex));
    }
  }
  ...
  else if (IOSwitchRegister == (uint8_t) 0x20)
  {
    ...
    {
      /* Close the Input Output switch */
      RI_IOSR2 |= (uint8_t) ((uint8_t)1 << IOSwitchIndex);
    }
    else
    {
      /* Open the Input Output switch */
      RI_IOSR2 &= (uint8_t) (~(uint8_t)((uint8_t)1 <<  IOSwitchIndex));
    }
  }
  ...
  else if (IOSwitchRegister == (uint8_t) 0x30)
  {
    ...
    {
      /* Close the Input Output switch */
      RI_IOSR3 |= (uint8_t) ((uint8_t)1 << IOSwitchIndex);
    }
    else
    {
      /* Open the Input Output switch */
      RI_IOSR3 &= (uint8_t) (~ (uint8_t) ((uint8_t) 1 << IOSwitchIndex));
    }
  }
  ...
  else
  {
    ...
    {
      /* Close the Input Output switch */
      RI_IOSR4 |= (uint8_t) ((uint8_t)1 << IOSwitchIndex);
    }
    else
    {
      /* Open the Input Output switch */
      RI_IOSR4 &= (uint8_t) (~ (uint8_t) ((uint8_t) 1 << IOSwitchIndex));
    }
  }
}
...
void SYSCFG_REMAPDeInit(void)
{
  ...
  SYSCFG_RMPCR1 = SYSCFG_RMPCR1_RESET_VALUE;

  /*!< Set RMPCR2 to reset value */
  SYSCFG_RMPCR2 = SYSCFG_RMPCR2_RESET_VALUE;

  /*!< Set RMPCR3 to reset value */
  SYSCFG_RMPCR3 = SYSCFG_RMPCR3_RESET_VALUE;
}
...
void SYSCFG_REMAPPinConfig(REMAP_Pin_TypeDef REMAP_Pin, FunctionalState NewState)
{
  ...
  else if (regindex == 0x02)
  {
    if (NewState != DISABLE)
    {
      SYSCFG_RMPCR2 |= (uint8_t) REMAP_Pin;
    }
    else
    {
      SYSCFG_RMPCR2 &= (uint8_t)((uint16_t)(~(uint16_t)REMAP_Pin));
    }
  }
  ...
  else
  {
    if (NewState != DISABLE)
    {
      SYSCFG_RMPCR3 |= (uint8_t) REMAP_Pin;
    }
    else
    {
      SYSCFG_RMPCR3 &= (uint8_t)((uint16_t)(~(uint16_t)REMAP_Pin));
    }
  }
}
...
void SYSCFG_REMAPDMAChannelConfig(REMAP_DMAChannel_TypeDef REMAP_DMAChannel)
{
  ...
  if ((REMAP_DMAChannel & 0xF0) != RESET)
  {
    ...
    SYSCFG_RMPCR1 &= (uint8_t) (~SYSCFG_RMPCR1_TIM4DMA_REMAP);
  }
  /* ADC DMA channel is selected: bits 4 --> 7 are reset */
  else
  {
    /* Reset the ADC DMA channels */
    SYSCFG_RMPCR1 &= (uint8_t) (~SYSCFG_RMPCR1_ADC1DMA_REMAP);
  }
  /* Set the DMA Channels remapping */
  SYSCFG_RMPCR1 |= (uint8_t) ((uint8_t)0x0F & REMAP_DMAChannel);
}
